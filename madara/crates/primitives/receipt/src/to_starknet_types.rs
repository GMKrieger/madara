...
impl TransactionReceipt {
    pub fn to_starknet_types(self, finality_status: mp_rpc::v0_7_1::TxnFinalityStatus) -> mp_rpc::v0_7_1::TxnReceipt {
        match self {
            TransactionReceipt::Invoke(receipt) => {
                mp_rpc::v0_7_1::TxnReceipt::Invoke(receipt.to_starknet_types(finality_status))
            }
            TransactionReceipt::L1Handler(receipt) => {
                mp_rpc::v0_7_1::TxnReceipt::L1Handler(receipt.to_starknet_types(finality_status))
            }
            TransactionReceipt::Declare(receipt) => {
                mp_rpc::v0_7_1::TxnReceipt::Declare(receipt.to_starknet_types(finality_status))
            }
            TransactionReceipt::Deploy(receipt) => {
                mp_rpc::v0_7_1::TxnReceipt::Deploy(receipt.to_starknet_types(finality_status))
            }
            TransactionReceipt::DeployAccount(receipt) => {
                mp_rpc::v0_7_1::TxnReceipt::DeployAccount(receipt.to_starknet_types(finality_status))
            }
        }
    }
}
...
impl From<L1Gas> for mp_rpc::v0_7_1::DataAvailability {
...
mod test {
    ...
    fn test_l1_tx_receipt_full_hash() {
        ...
        let message_hash = l1_transaction_receipt.to_starknet_types(mp_rpc::v0_7_1::TxnFinalityStatus::L1).message_hash;
